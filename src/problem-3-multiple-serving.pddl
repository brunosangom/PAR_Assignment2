(define (problem multiple_servings)
    ...
    (:init
        ...
        ;; Dish priorities (sushi1 > sushi2 > ramen1 > ramen2 > ramen3)
        (prioritize-dish sushi1 sushi2)
        (prioritize-dish sushi1 ramen1)
        (prioritize-dish ramen1 ramen2)
        (prioritize-dish ramen2 ramen3)
